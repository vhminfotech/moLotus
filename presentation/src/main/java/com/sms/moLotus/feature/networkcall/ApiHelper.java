package com.sms.moLotus.feature.networkcall;
...
public class ApiHelper extends ContextWrapper {
    ...
    public void request(String phoneNo, final RequestResponse successReceiver,
        ...
        sendRequest(R.string.url_request, params, (Response.Listener<JSONObject>) response -> {
    ...
    public void verify(String phoneNo, String smsMessage, final VerifyResponse successReceiver,
        ...
        sendRequest(R.string.url_verify, params, (Response.Listener<JSONObject>) response -> {
            Boolean success = false;
            String phoneNo1 = null;
            try {
                success = response.getBoolean(RESPONSE_SUCCESS);
                phoneNo1 = response.getString(RESPONSE_PHONE);
            } catch (JSONException e) {
                Log.e(TAG, "Possible missing response value.", e);
            }
            successReceiver.onResponse(success, phoneNo1);
        }, error -> failureReceiver.onError(error));
    }
    ...
    protected void sendRequest(String url, HashMap<String, String> params, Response.Listener success,
                               Response.ErrorListener failure) {
        /*String secret = getString(R.string.server_client_secret_v8);
        ...
        try {
            ...
            args.put("client_secret", "OKCVofivJYE");
